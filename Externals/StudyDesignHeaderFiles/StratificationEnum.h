...
@interface StratificationEnum : NSObject
...
@property (assign, nonatomic) StratificationVariableEnum *stratificationVariableEnum;

-(id) initWithIdx:(const NSString*)theIdx;
-(StratificationVariableEnum *) parseIdx:(const NSString*)theIdx;
