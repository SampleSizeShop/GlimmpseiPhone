...
@interface RepeatedMeasuresNodeList : NSObject

{
    ...
    NSMutableArray const*repeatedMeasuresList;
}

@property (strong, nonatomic) NSMutableData const*uuid;
@property (strong, nonatomic) NSMutableArray const* repeatedMeasuresList;;
